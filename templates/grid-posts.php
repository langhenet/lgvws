  ...
  <div class="articles-grid__item-container">
    <a class="grid-item__image-container" href="<?php the_permalink() ?>" title="<?php the_title(); ?>">
      ...
      <div class="grid-item__meta-container">
        <p class="grid-item__meta package-item__meta">
          <?php echo __('Duration' , 'activities') . ': ' . $articlemeta['wpcf-lg-duration'][0] . ' ' . __('hours' , 'activities'); ?>
        </p>
      </div>
    </a>
    ...
    <div class="grid-item__description-container">
      <p>
        ...
        <a href="<?php the_permalink() ?>" title="<?php the_title(); ?>" class="articles__read-more"><?php _e('Read More' , 'GeneralText') ?> &raquo;</a>
      </p>
    </div>
    <div class="grid-item__footer">
      <div class="grid-item__additional-info-container">
      <p class="articles__price"><strong><?php echo $articlemeta['wpcf-lgp-price'][0] ?>€</strong></p>
      </div>
      <div class="grid-item__cta-container">
        <a id="book-now--<?php echo $articlemeta['wpcf-lg-trekksoft-activity'][0] ?>" href="#" title="<?php the_title(); ?>" class="grid-item__book-now"><?php _e('Book Now' , 'activities') ?></a>
        ...
        <script>
            (function() {
                ...
                button
                      ...
                      .setAttrib("tourId", "<?php echo $articlemeta['wpcf-lg-trekksoft-activity'][0] ?>")
                      .setAttrib("fancywidth", "95%")
                      .registerOnClick("#book-now--<?php echo $articlemeta['wpcf-lg-trekksoft-activity'][0] ?>");
            })();
        </script>
      </div>
    </div>
